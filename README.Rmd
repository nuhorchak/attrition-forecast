...
[![Build Status](https://travis-ci.org/hadley/devtools.svg?branch=master)](https://travis-ci.org/jaketelliott/attrition-forecast)

[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/jaketelliott/attrition-forecast?branch=master&svg=true)](https://ci.appveyor.com/project/jaketelliott/attrition-forecast)
