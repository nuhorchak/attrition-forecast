...
[![Build Status](https://travis-ci.org/jtelliott/attrition-forecast.svg?branch=master)](https://travis-ci.org/jtlliott/attrition-forecast)

[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/jtelliott/attrition-forecast?branch=master&svg=true)](https://ci.appveyor.com/project/jtelliott/attrition-forecast)
